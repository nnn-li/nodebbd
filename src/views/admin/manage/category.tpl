						...
						<div class="panel-body">
							...
							<fieldset>
								<div class="form-group text-center">
									...
									<button type="button" class="btn btn-default btn-block <!-- IF category.parent.name -->hide<!-- ENDIF category.parent.name -->" data-action="setParent"><i class="fa fa-sitemap"></i> (无)</button>
								</div>
							</fieldset>
