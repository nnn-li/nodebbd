...
<div class="row">
	...
	<div class="col-sm-10 col-xs-12">
		<form>
			<strong>帖子获得投票最小上下威望</strong><br /> <input type="text" class="form-control" placeholder="0" data-field="privileges:downvote"><br />
			<strong>帖子获得 flag 最小上下威望</strong><br /> <input type="text" class="form-control" placeholder="0" data-field="privileges:flag"><br />
		</form>
	</div>
</div>
